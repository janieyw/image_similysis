...
crowd_data = np.loadtxt('./data/Personal.txt', dtype=np.int32)
...
with open("step6_results.html", "w") as file:
    file.write("<html>\n")
    file.write("<head>\n")
    file.write("<title>Step 6: Crowd vs. Me Results</title>\n")
    file.write("<h1>Step 6: Crowd vs. Me Results</h1>\n")
