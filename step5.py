...
with open("step5_results.html", "w") as file:
    file.write("<html>\n")
    file.write("<head>\n")
    file.write("<title>Overall Similarity Results</title>\n")
    file.write("<h1>Overall Similarity Results</h1>\n")
...
for i in range(1, 41):
    ...
    if os.path.exists(query_path):
        ...
        C_score = step1.similarity_scores[query_file][0]
        T_score = step2.similarity_scores[query_file][0]
        S_score = step3.similarity_scores[query_file][0]
        Y_score = step4.similarity_scores[query_file][0]
